...
- $D_1 \sim \chi^2_{n-k}$.
- $D_A \sim \chi^2_{n-m}$.
- Se sabe que $\chi^2_a + \chi^2_b \sim \chi^2_{a+b} \Rightarrow D_A - D_1 \sim \chi^2_{(n-m)-(n-k)} = \chi^2_{k-m}$.

Por tanto, para resolver el contraste se utiliza el estadístico
