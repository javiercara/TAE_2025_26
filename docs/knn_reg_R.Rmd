...
- Se definen las variables auxiliares. En este caso se deciden utilizar tantas variables auxiliares como niveles del factor:
...
xp1$genero_M = ifelse(xp1$genero == "macho", 1, 0)
```
...
## Método de los datos de entrenamiento y datos test

- Se dividen los datos en dos partes: datos de entrenamiento y datos test. Esta división suele ser aleatoria. El tamaño de los datos de entrenamiento tiene que ser mayor (80%-20%, 70%-30%,...).
...
$$
R^2 = 1 - \frac{\sum res_i^2}{\sum (y_i-\bar y)^2}
$$
...
- Podemos utilizar este resultado para calcular el mejor valor de k:
